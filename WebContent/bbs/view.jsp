...
<div class="reply_view">
	...
	<div class="dap_lo">
		...
		<div><input type="hidden" name="bbsIdx" value="<%= list.get(i).getBbsIdx() %>" /></div>
			<div><b><%= list.get(i).getUserName()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></t><%= list.get(i).getRepDate()%></div>
			<div class="dap_to comt_edit"><%= list.get(i).getRepContent() %></div>
			<div class="rep_me rep_menu">
				<a class="dat_edit_bt" href="/BBS_JSP/bbs/repUpdate.jsp?repIdx=<%= list.get(i).getRepIdx() %>&&bbsIdx=<%= list.get(i).getBbsIdx() %>">수정</a>
